...
class config:
    ...
    BOT_TOKEN = "7264100492:AAGv2f25-hP5X0FaaVLCodwb-ot5aXTpNuA"
    ...
    CHANNEL_ID = (
        [int(i.strip()) for i in os.environ.get("CHANNEL_ID", "-1002164324973").split(" ")]
    ...
    DB_CHANNEL = int(os.environ.get("DB_CHANNEL", "-1002164324973"))
    LOG_CHANNEL = int(os.environ.get('LOG_CHANNEL', "-1002164324973"))
    FILE_STORE_CHANNEL = [int(ch) for ch in (os.environ.get('FILE_STORE_CHANNEL', '-1002164324973')).split()]
